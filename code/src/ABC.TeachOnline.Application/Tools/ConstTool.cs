...
// idChars are characters allowed in captcha id.
    public static  char[] idChars =(TxtNumbers + TxtAlphabet).ToCharArray();


    public const double imageStringDpi = 72.0;

    //TxtNumbers chacters for numbers.
    public const string TxtNumbers = "012346789";

    //TxtAlphabet characters for alphabet.
    public const string TxtAlphabet = "ABCDEFGHJKMNOQRSTUVXYZabcdefghjkmnoqrstuvxyz";

    //TxtSimpleCharaters simple numbers and alphabet
    public const string TxtSimpleCharaters = "13467ertyiadfhjkxcvbnERTYADFGHJKXCVBN";

    //TxtChineseCharaters makes characters in chinese
    public const string TxtChineseCharaters = "的一是在不了有和人这中大为上个国我以要他" +
    ...
    public const string stringMimeTypeAudio = "audio/wav";

    //MimeTypeImage output base64 mine-type.
    public const string MimeTypeImage = "image/png";
...
//var cjkFontFamilies = readCJKFonts()
    ...
    public const int OptionShowHollowLine = 2;
    //OptionShowSlimeLine shows slime line

    public const int OptionShowSlimeLine = 4;

    //OptionShowSineLine shows sine line
    public const int OptionShowSineLine = 8;
}